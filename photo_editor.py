...
for number in range(1,6):
    ...
    if not os.path.isdir(f'photo11U/{file_path}'):
    ...
    cordinates = (10, 0, image_Inst.width-10, image_Inst.height)
    cropped_image_Inst = image_Inst.crop(cordinates)
    cropped_image_Inst.save(f"photo11U/photo_end_{number}/photo_Inst.png", "png")
